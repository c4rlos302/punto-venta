<div class="mx-auto max-w-2xl space-y-6">
    ...
    <form wire:submit="save" class="space-y-6 rounded-xl border bg-white p-6 shadow-sm">
        ...
        <div>
            ...
            <input type="text" wire:model="name" class="w-full rounded-lg border-zinc-300">
        ...
        <div>
            ...
            <input type="email" wire:model="email" autocomplete="off" class="w-full rounded-lg border-zinc-300">
        ...
        <div>
            ...
            <input type="password" wire:model="password" autocomplete="new-password"
                class="w-full rounded-lg border-zinc-300" placeholder="Déjalo vacío para conservar la actual">
